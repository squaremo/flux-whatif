...
// This was added by squaremo.
func WithClient(c client.WithWatch) BuilderOptionFunc {
	return func(b *Builder) error {
		b.client = c
		b.restMapper = c.RESTMapper()
		return nil
	}
}
...
func NewBuilder(name, resources string, opts ...BuilderOptionFunc) (*Builder, error) {
	...
	// squaremo: commented out; I don't understand this restriction :-S
